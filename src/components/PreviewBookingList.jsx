      ...
      {books.length > 0 && (
        <div className="table-container">
          <table className="booking-table">
            <thead className="bg-gray-100/50">
              <tr className="text-black text-left">
                {tableHead?.map((head, index) => (
                  <th className="text-center" key={index} value={head}>
                    {head}
                  </th>
                ))}
              </tr>
            ...
            >
              {books.map((book) => (
                <tr className="lws-bookedTable text-black" key={book.id}>
...
export default PreviewBookingList;
